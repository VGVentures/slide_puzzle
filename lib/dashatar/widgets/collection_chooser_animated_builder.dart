    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          CollectionChooserEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
    CollectionChooserEnterAnimation animation,
);

class CollectionChooserEnterAnimation {
  CollectionChooserEnterAnimation(this.controller)
